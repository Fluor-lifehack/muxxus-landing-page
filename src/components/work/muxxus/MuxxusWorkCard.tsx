  ...
  return (
    <Link href={`/work/web/${slug}`}>
      <div className="group relative max-w-[380px] md:max-w-[480px] lg:max-w-[580px] xl:max-w-[680px] 2xl:max-w-[880px] mr-[10px]">
        ...
        <div className="invisible group-hover:visible group-hover:opacity-100 absolute w-full h-full top-0 start-0 bg-[#FFFFFFE5] flex flex-col justify-end pt-[45px] px-[45px] pb-[50px] opacity-0 transition-all duration-900">
