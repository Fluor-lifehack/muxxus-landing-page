...
const ProductDetailHero = ({ title, sub_title, shape_1, shape_2, info }: Props) => {
  ...
  return (
    <section ref={containerRef} className="w-full">
      <div className="w-full max-w-none px-0">
        <div className="pb-11 pt-[67px] 2xl:pb-[94px] 2xl:pt-[97px] relative z-[1] px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-16">
