...
const MuxxusFeatureCard2 = ({ icon, title, description }: Props) => {
  return (
    <div
    ...
    >
      ...
      <div>
        <h3 className="text-[24px] leading-none text-text-fixed">{title}</h3>
        <p className="mt-[16px] text-text-3">{description}</p>
      </div>
    </div>
  );
};

export default MuxxusFeatureCard2;
